...
public class Page {
    ...
    /**
     * Returns the boolean value at the specified offset of the page. If a
     * boolean was not stored at that location, the behavior of the method is
     * unpredictable.
     *
     * @param offset the byte offset within the page
     * @return the string value at that offset
    ...
    public void setBoolean( int offset, boolean val ) {
        contents.position( offset );
        byte[] boolByte = new byte[]{ (byte) ( val ? 1 : 0 ) };
        contents.putInt( boolByte.length );
        contents.put( boolByte );
    }
}
