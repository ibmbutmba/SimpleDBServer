...
public class BasicLogRecord {
    ...
    public boolean nextBoolean() {
        Boolean result = pg.getBoolean( pos );
        int booleanLength = result.toString().length();
        int boolPos = (byte) (result ? 1 : 0);
        System.out.println( "simpledb.log.basicLogRecord says : boolean length is " + booleanLength );
        System.out.println( "simpledb.log.basicLogRecord says : boolPos byte is " + boolPos );
        pos += boolPos;
        return result;
