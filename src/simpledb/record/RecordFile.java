...
public class RecordFile {
    ...
    /**
     * ADDITIONAL FUNCTIONALITY Returns the value of the specified field in the
     * current record.
     *
     * @param fldname the name of the field
     * @return the string value at that field
    ...
    public boolean getBoolean( String fldname ) {
        System.out.println( "record.RecordFile says : getBoolean( String : " + fldname + " )" );
    ...
    /**
     * ADDITIONAL FUNCTIONALITY Sets the value of the specified field in the
     * current record.
     *
     * @param fldname the name of the field
     * @param val the new value for the field
