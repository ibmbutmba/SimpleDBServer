...
public class RecordPage {
    ...
    /**
     * ADDITIONAL FUNCTIONALITY Returns the Boolean value stored for the
    ...
    public boolean getBoolean( String fldname ) {
        System.out.println( "record.RecordPage says : getBoolean( String : " + fldname + " )" );
        int position = fieldpos( fldname );
    ...
    /**
     * Stores a boolean at the specified field of the current record.
     *
     * @param fldname the name of the field
     * @param val the boolean value stored in that field
     */
    public void setBoolean( String fldname, boolean val ) {
        System.out.println( "record.RecordPage says : setBoolean( String : " + fldname + ", bool :" + val + " )" );
        int position = fieldpos( fldname );
